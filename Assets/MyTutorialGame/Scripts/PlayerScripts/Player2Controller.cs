...

{
    ...
    public static PlayerStateSerial player2Serial;

    public static PlayerStateMono player2;
...

    {
        ...
        player2 = GetComponent<PlayerStateMono>();
...

        {
            ...
            player2Serial = new PlayerStateSerial

                (GameState.Current.Player2Serial.xPos,

                 GameState.Current.Player2Serial.yPos,

                 GameState.Current.Player2Serial.facing,

                 GameState.Current.Player2Serial.active);
...

        {
            ...
            player2Serial = new PlayerStateSerial(0f, 0f, 0, true);
