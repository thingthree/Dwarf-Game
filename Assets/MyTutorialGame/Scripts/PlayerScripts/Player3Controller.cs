...

{
    ...
    public static PlayerStateSerial player3Serial;

    public static PlayerStateMono player3;
...

    {
        ...
        player3 = GetComponent<PlayerStateMono>();
...

        {
            ...
            player3Serial = new PlayerStateSerial

                (GameState.Current.Player3Serial.xPos,

                 GameState.Current.Player3Serial.yPos,

                 GameState.Current.Player3Serial.facing,

                 GameState.Current.Player3Serial.active);
...

        {
            ...
            player3Serial = new PlayerStateSerial(0f, 0f, 0, true);
