...

{
    ...
    public static PlayerStateSerial player7Serial;

    public static PlayerStateMono player7;
...

    {
        ...
        player7 = GetComponent<PlayerStateMono>();
...

        {
            ...
            player7Serial = new PlayerStateSerial

                (GameState.Current.Player7Serial.xPos,

                 GameState.Current.Player7Serial.yPos,

                 GameState.Current.Player7Serial.facing,

                 GameState.Current.Player7Serial.active);
...

        {
            ...
            player7Serial = new PlayerStateSerial(0f, 0f, 0, true);
