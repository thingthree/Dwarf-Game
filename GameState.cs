...
public class GameState 
{
    ...
    public UnitStateSerial Player2Serial { get; set; }
    public UnitStateSerial Player3Serial { get; set; }
    public UnitStateSerial Player4Serial { get; set; }
    public UnitStateSerial Player5Serial { get; set; }
    public UnitStateSerial Player6Serial { get; set; }
    public UnitStateSerial Player7Serial { get; set; }
